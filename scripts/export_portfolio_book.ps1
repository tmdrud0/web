...
$htmlPath = (Resolve-Path (Join-Path $pdfRoot "portfolio-book.html")).Path
$pdfPath = Join-Path $distRoot "portfolio-book.pdf"
...
if (-not $exported) {
    throw "Failed to export portfolio-book.html"
}
