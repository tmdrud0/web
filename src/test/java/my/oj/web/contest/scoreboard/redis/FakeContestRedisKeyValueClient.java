...
/** In-process stand-in for Redis, enough for the scoreboard store's command set. */
public final class FakeContestRedisKeyValueClient implements ContestRedisKeyValueClient {
